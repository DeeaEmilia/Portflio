...
const monthData = {
    ...
    june: [
        'In June, I will continue to practice React and revise what I have learned so far. Furthermore, I will begin working on a more complex project to encompass most of my current knowledge.',
        '▪ Practice',
        '▪ Practice',
        '▪ Practice',
    ],
    july: [
        'In July, I plan on exploring more complex React techniques couples with Next.js and develop my skills TypeScript.',
        '▪ Server Side Rendering',
        '▪ Static Site Generation',
        '▪ TypeScript',
    ],
    august: [
        'In August, I will explore the avenue of website optimization. I will take a closer look at:',
        '▪ Performance Metrics',
        '▪ Lighthouse',
        '▪ Yellowlab Tools',
    ],
    september: [
        'In September, my plan is to complete 2-3 complex projects and potentially look into authentication strategies and progressive web apps',
        '▪ OAuth',
        '▪ SSO',
        '▪ Session Auth',
        '▪ PWAs',
